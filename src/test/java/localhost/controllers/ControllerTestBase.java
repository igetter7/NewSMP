...
import localhost.NewSMPShopManagementPlatformClient;
...
public class ControllerTestBase {
    ...
    private static NewSMPShopManagementPlatformClient client;
     ...
     * @return
     */
    protected static NewSMPShopManagementPlatformClient getClient() {
        if (client == null) {
            synchronized (clientSync) {
                if (client == null) {
                    client = new NewSMPShopManagementPlatformClient();
                }
            }
        }
        return client;
